  ...
  return (
    <header className="fixed inset-x-0 top-0 z-40">
      ...
      <button
        ...
        className={cn(
          "fixed right-3 bottom-3 z-50 flex size-10 cursor-pointer items-center justify-center rounded-full transition-all duration-150 hover:bg-[#8883] hover:opacity-100 active:scale-[0.97] active:bg-[#8882] active:opacity-100 print:hidden",
