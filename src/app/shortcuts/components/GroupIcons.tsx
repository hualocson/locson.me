...
import { Package2Icon, Terminal } from "lucide-react";
...
const GroupIcons = ({ icon }: { icon?: string }) => {
  switch (icon?.toLowerCase()) {
    case "code":
      return <VisualStudioCodeIcon className="size-4" />;
    case "apple":
      return <AppleIcon className="size-4" />;
    case "terminal":
      return <Terminal className="size-4" />;
    default:
      return <Package2Icon className="size-4" />;
  }
};
